...
<script type="text/javascript">
			function addProduct(){
				window.location.href = "${pageContext.request.contextPath}/adminAllProductUI";
			}
			...
			function alterProduct(pid) {
				location.href="${pageContext.request.contextPath}/adminAlterProduct?pid="+pid;
			}
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach items="${ProductList }" var="pro" varStatus="vs">
									<tr onmouseover="this.style.backgroundColor = 'white'"
										...
										<a	href="javascript:void(0)" onclick="alterProduct('${pro.pid}')">
												<img
